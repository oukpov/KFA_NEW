...
Text("New Auto",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white,fontSize: 20),),
Text("Auto List",style: TextStyle(fontWeight: FontWeight.bold,color: Colors.white,fontSize: 20),)
];
...
class _MenuAutoState extends State<MenuAuto> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        centerTitle: true,
        title: Text("Auto",style: TextStyle(fontWeight: FontWeight.bold,fontSize: 20,color: Colors.white ),),
      ),
      body: Container(
